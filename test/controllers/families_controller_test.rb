...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { husb_key: @family.husb_key, key: @family.key, name: @family.name, wife_key: @family.wife_key } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { husb_key: @family.husb_key, key: @family.key, name: @family.name, wife_key: @family.wife_key } }
